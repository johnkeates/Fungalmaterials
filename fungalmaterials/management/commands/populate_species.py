...
class Command(BaseCommand):
	...
	def handle(self, *args, **kwargs):
		...
		species_data = [
			...
			{"name": "Apioperdon pyriforme", "phylum": "Basidiomycota"},
			{"name": "Armillaria mellea", "phylum": "Basidiomycota"},
			{"name": "Armillaria tabescens", "phylum": "Basidiomycota"},
			...
			{"name": "Aspergillus versicolor", "phylum": "Ascomycota"},
			{"name": "Aureobasidium melanogenum", "phylum": "Ascomycota"},
			{"name": "Aureobasidium pullulans", "phylum": "Ascomycota"},
			{"name": "Auricularia auricula-judae", "phylum": "Basidiomycota"},
			{"name": "Auricularia mesenterica", "phylum": "Basidiomycota"},
			{"name": "Auricularia polytricha", "phylum": "Basidiomycota"},
			...
			{"name": "Cerioporus squamosus", "phylum": "Basidiomycota"},
			{"name": "Cerioporus varius", "phylum": "Basidiomycota"},
			...
			{"name": "Coriolopsis gallica", "phylum": "Basidiomycota"},
			{"name": "Crepidotus applanatus", "phylum": "Basidiomycota"},
			{"name": "Crucibulum laeve", "phylum": "Basidiomycota"},
			{"name": "Cyathus striatus", "phylum": "Basidiomycota"},
			...
			{"name": "Ganoderma adspersum", "phylum": "Basidiomycota"},
			...
			{"name": "Heterobasidion annosum", "phylum": "Basidiomycota"},
			...
			{"name": "Lentinus lepideus", "phylum": "Basidiomycota"},
			...
			{"name": "Penicillium crustosum", "phylum": "Ascomycota"},
			...
			{"name": "Phellinus nigricans", "phylum": "Basidiomycota"},
			...
			{"name": "Pleurotus sajor-caju", "phylum": "Basidiomycota"},
			...
			{"name": "Stereum subtomentosum", "phylum": "Basidiomycota"},
			...
			{"name": "Trametes elegans", "phylum": "Basidiomycota"},
			...
			{"name": "Xylobolus frustulatus", "phylum": "Basidiomycota"},
		]
