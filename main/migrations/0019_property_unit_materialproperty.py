    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.property')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.species')),
                ('substrate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.substrate')),
